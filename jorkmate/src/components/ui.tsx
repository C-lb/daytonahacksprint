...
export const inputCls =
  'w-full rounded-xl border border-charcoal/15 bg-surface px-3.5 py-2.5 text-[15px] text-charcoal placeholder:text-charcoal-soft/60 focus:border-coral focus:outline-none'
          ...
          <button
            ...
            className={`rounded-full border px-3.5 py-1.5 text-sm font-medium transition-colors active:scale-95 ${
              active
                ...
                : 'border-charcoal/20 bg-surface text-charcoal hover:border-coral/50'
            }`}
          >
            {opt}
          </button>
...
export function SectionCard({ title, children }: { title: string; children: ReactNode }) {
  return (
    <section className="mb-4 rounded-2xl bg-surface p-4 raised">
